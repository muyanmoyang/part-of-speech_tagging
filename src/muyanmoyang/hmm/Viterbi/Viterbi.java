...
public class Viterbi {
	public static void main(String[] args) {
		...
		try { // 读取199801train.txt文本中的内容，并保存在content的字符流中
			reader = new BufferedReader(new FileReader("D:/￥烟酒僧/文本挖掘/Project/Wordpos/199801train.txt"));
			String line;
		...
		try { // 读取test.txt文本中的内容，并保存在sentence的字符流中。
			BufferedReader str = new BufferedReader(new FileReader(
					"D:/￥烟酒僧/文本挖掘/Project/Wordpos/199801test.txt"));
			String line;
		...
		String[] test;
		test = sentence.split("(/[a-z]*\\s{0,})|(][a-z]*\\s{1,})");// 去除词性标注
