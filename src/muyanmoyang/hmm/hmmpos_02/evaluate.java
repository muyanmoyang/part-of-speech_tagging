...
public class evaluate
{
	...
	public void test()throws Exception{//统计
		 ...
		 //统计出训练样本中词性种类及其频率
		  ...
		  File file=new File("pos//train1.txt");
	     ...
	     */
	      ...
	      */
		     ...
		     */
			File fileResult = new File("pos//test.txt");
		    byte[] bs1 = new byte[bufSize];
		    ByteBuffer byteBuff = ByteBuffer.allocate(bufSize);
		    FileChannel channel = new RandomAccessFile(fileResult,"r").getChannel();
		    int size1;
		    size1 = channel.read(byteBuff);
		    byteBuff.rewind();
		    byteBuff.get(bs1);
		    sentence=new String(bs1, 0, size1); 
            fileChannel.close();
	     String[] test;
